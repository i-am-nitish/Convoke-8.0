...
const SCHEDULE = {
    'DAY 1 — APR 9': [
        ...
        { time: '09:00', event: 'PHOTOGRAPHY', type: 'fun' },
        ...
        { time: '13:00', event: 'IPL AUCTION', type: 'fun' },
        { time: '18:00', event: 'END OF DAY 1', type: 'EOD1' },
    ],
    'DAY 2 — APR 10': [
        { time: '09:00', event: 'PHOTOGRAPHY', type: 'fun' },
        { time: '10:00', event: 'KNOWLEDGE QUARRY', type: 'tech' },
        { time: '10:00', event: 'HashHacks - HACKATHON START', type: 'tech' },
        { time: '10:00', event: 'ESCAPE ROOM', type: 'fun' },
        { time: '10:00', event: 'MICRO MOUSE', type: 'robotics' },
    ],
    'DAY 3 — APR 11': [
