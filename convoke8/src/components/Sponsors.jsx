...
const SPONSORS = [
    ...
    { name: 'Give My Certificate', caption: 'Certificate Partner', logo: '/give_my_cert_logo.png', website: 'https://givemycertificate.com/' },
    { name: 'UnStop', caption: 'Platform Partner', logo: '/unstop-logo.svg', website: 'https://unstop.com/' },
